...
def simulate_and_compare(varparams, varparamkeys, system, data_arrays, to, 
                         light, powers=None, irf_args={}, N_coarse=500, 
    ...
    irf_args : dictionary
        Arguments for simulating the IRF. See``sim.lib.convolve_irf`` and 
        ``sim.lib.build_irf`` function. Default is 40 ps.
    N_coarse : integer
...
def sac_args(varparamkeys, system, data_arrays, to, 
                         light, powers=None, irf_args={}, N_coarse=500, roll_value=0, 
